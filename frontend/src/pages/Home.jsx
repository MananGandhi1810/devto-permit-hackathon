...
function Home() {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            setFloatingContainers((prev) =>
                prev.map((container) => ({
                    ...container,
                    y:
                        container.y +
                        container.speed * container.direction * 0.1,
                    direction:
                        container.y <= 10 || container.y >= 90
                            ? -container.direction
                            : container.direction,
                })),
            );
        ...
        <div className="relative min-h-full-w-nav overflow-hidden bg-gradient-to-b from-gray-900 to-black text-white">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center p-8 h-full-w-nav">
                ...
                <p className="text-lg text-gray-400 mb-8 text-center max-w-md">
                    Master your Docker containers with intelligent role-based
                    access control
                </p>
